<html>
    ...
    if(!empty($_POST["user_name"])&&!empty($_POST["user_comment"])&&!empty($_POST["pass"])){
...
<!-- 投稿フォーム作成 -->
	...
	<form method="post">
		...
		<input type="text" id ="user_comment" name="user_comment" value="<?php echo $editcomment; ?>">
        <br>
